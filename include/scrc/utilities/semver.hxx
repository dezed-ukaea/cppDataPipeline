    ...
    class version
    {
        public:
            ...
            version(const version& v) :
                ...
                minor_(v.minor_),
                patch_(v.patch_),
                meta_tag_(v.meta_tag_),
                tag_v_(v.tag_v_),
                meta_data_(v.meta_data_) {}
            ...
            friend bool operator<(const version& v1, const version& v2)
            {
                ...
                else if(v2.major_ < v1.major_) return false;
                if(v1.minor_ < v2.minor_) return true;
                else if(v2.minor_ < v1.minor_) return false;
                if(v1.patch_ < v2.patch_) return true;
                else if(v2.patch_ < v1.patch_) return false;
                if(v1.meta_tag_ < v2.meta_tag_) return true;
                else if(v2.meta_tag_ < v1.meta_tag_) return false;
                if(v1.tag_v_ < v2.tag_v_) return true;
                else if(v2.tag_v_ < v1.tag_v_) return false;
                return false;
            }
