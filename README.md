...
void read_param_demo() {
    const ghc::filesystem::path toml_file = "/path/to/estimate/0.1.0.toml";
...
void read_array_demo() {
    const ghc::filesystem::path array_file = "path/to/array/0.20210427.0.h5";
    const ghc::filesystem::path component = "test_array";
...
void read_table_col_demo() {
    const ghc::filesystem::path array_file = "path/to/array/0.20210427.0.h5";
    const ghc::filesystem::path component = "test_table";
...
void read_distribution_demo() {
    const ghc::filesystem::path toml_file = "/path/to/distribution/0.1.0.toml";
...
void create_param_demo() {
    const ghc::filesystem::path config_file = "path/to/config.yaml";
...
void create_array_demo() {
    ...
    const ghc::filesystem::path data_product = "test_data/test_arrays";
    const ghc::filesystem::path component = "demo_1";
